...
4. usar `01-base-empirica-geral.md` como índice mestre da serie `01` e abrir o filho empirico mais aderente (`01a` a `01h`, filhos empíricos; `01j`/`01k` são docs operacionais/governança fora desse mapa)
