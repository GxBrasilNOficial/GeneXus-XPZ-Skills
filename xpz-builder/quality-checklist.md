...
- [ ] When an existing corpus object needed initial seed into the front, `Copy-GeneXusAcervoToFront.ps1` was called with explicit `-ObjectList`, `-ObjectNames`, or `-ObjectGuids`; no implicit seed of a whole empty front was assumed.
