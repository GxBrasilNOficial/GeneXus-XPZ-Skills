...
- [01e-moldes-sanitizados-core.md](../../01e-moldes-sanitizados-core.md) — sanitized API molds: the dense `APIExemploIntegracao` and the minimal self-contained triad (API + implementation Procedure + request/response SDT).
- `999-ideias-pendentes.md` — entry «Criar/alterar objeto GeneXus do tipo `API` (from-spec, com segurança GAM)» and its «Resultados da Fase 0 empírica» block (empirical evidence, dated KMW 4.0.187794 + GAM 3.15.78).
