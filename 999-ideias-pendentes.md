...
**Status:** Fase 0 empírica **completa**. Próximo = fases documentais (A: `api.md` + satélite `api-gam-runtime.md`; enriquecer `01e`; recalibrar `03` + tabela de risco; estender `02`/`08`/`10-base`/README) e B, com os achados acima incorporados. Ainda pendente de derivação empírica leve: **0b "autocontido"**.
