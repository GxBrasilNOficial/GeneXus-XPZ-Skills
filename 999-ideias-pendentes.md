...
- `xpz-llm-delegate/SKILL.md` (bullet de `Resolve-LlmDelegatePanelDiversity` / `Get-LlmDelegateTargetFamily`: incluir exemplo `nvidia/<criador>/*` → linhagem; hoje **não** afirma `nvidia` como família, mas precisa do exemplo pós-fix)
