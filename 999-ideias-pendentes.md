...
- **Maturidade** — pesquisa/ideia. O confinamento de leitura ao cwd **HERDADO** já está **ATIVO** (o reviewer-ro fixa `external_directory: deny`, medido nos fixtures ativos em 1.17.20); falta **mecanizar cwd-seguro** e **liberar `kb-sensitive`**.
