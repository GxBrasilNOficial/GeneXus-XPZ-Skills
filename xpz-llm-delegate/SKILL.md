...
4. Incluir subagente nativo quando fizer sentido: ele participa com o Criador do Modelo de
   `targetModelKey` (não usa a ferramenta corrente como família do piso) e não substitui sozinho
