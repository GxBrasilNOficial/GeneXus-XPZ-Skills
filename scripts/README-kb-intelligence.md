...
- `Regra operacional`: esse catalogo cobre só tipos modernos por GUID. Elementos de export **legado GeneXus 9** (`<GXObject><Elemento>` por nome, sem GUID de tipo) ficam no registro proprio `scripts/gx-legacy-export-element-registry.json` (doc-dono `01k-registro-elementos-legados.md`), não neste catalogo nem no indice KbIntelligence — o motor de export legado e frente futura
