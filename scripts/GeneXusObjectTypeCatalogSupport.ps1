...
function Get-GeneXusCatalogOverrideClassification {
    ...
    $ops=@('objectTypeGuid','rootKind','folderName','inventoryEligible','queryableByKbIntelligence','containerType','exportTaskLabel'); $req=@('objectTypeGuid','rootKind','folderName','inventoryEligible','queryableByKbIntelligence','containerType'); $meta=@('evidenceSummary','wikiLinks','nexaFindings','notes','lastObservedAt'); $supported=@($ops+$meta); $entries=[System.Collections.Generic.List[object]]::new()
